...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('police',0,'recruit','Officer',20,'{}','{}'),
	('police',1,'officer','Deputy',40,'{}','{}'),
	('police',2,'sergeant','Captain',60,'{}','{}'),
	('police',3,'lieutenant','Undersheriff',85,'{}','{}'),
	('police',4,'boss','Sheriff',100,'{}','{}')
;

CREATE TABLE `fine_types_lscs` (
...
INSERT INTO `fine_types_lscs` (label, amount, category) VALUES
