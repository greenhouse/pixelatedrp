...
Config.CooldownOnStealingCar = 10 * 60
...
Config.Zones = {
  ...
  SellCar = {
    Pos   = {x = -82.039, y = 363.687, z = 111.450},
...
Config.STRING_SOLD_CAR_VALUE = 'Your company earned: ~g~$'
Config.STRING_SOLD_CAR_VALUE2 = 'You earned: ~g~$'
