...
client_scripts {
	...
	'config.lua',
	'client.lua',
	'modules/scoreboard/native_board.lua',
	'modules/rconlog/rconlog_client.lua',
	'modules/hardcap/client.lua',
}
server_scripts {
	'@mysql-async/lib/MySQL.lua',
	'config.lua',
	'server.lua',
	'modules/rconlog/rconlog_server.lua',
	'modules/hardcap/server.lua',
}
