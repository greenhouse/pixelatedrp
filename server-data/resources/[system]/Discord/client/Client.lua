	...
	while true do
		...
		if IsEntityDead(PlayerPedId()) then
			...
			if DeathReason == 'committed suicide' or DeathReason == 'died' then
				...
				if DeathReason == '' then
					TriggerServerEvent('DiscordBot:PlayerDied', '```Markdown\n#' .. GetPlayerName(Killer) .. ' ' .. DeathReason .. ' ' .. GetPlayerName(PlayerId()) .. '.', Weapon)
				else
					TriggerServerEvent('DiscordBot:PlayerDied', '```css\n' .. GetPlayerName(Killer) .. ' ' .. DeathReason .. ' ' .. GetPlayerName(PlayerId()) .. '.', Weapon)
				end
			end
			Killer = nil
			DeathReason = nil
