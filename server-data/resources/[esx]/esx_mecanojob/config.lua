...
Config.Zones = {
  MecanoActions = {
    Pos   = { x = -1139.09, y = -1701.29, z = 3.45 },
  ...
  Garage = {
    Pos   = { x = -1133.93, y = -1688.63, z = 3.45 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 27,
  },
  ...
  Craft = {
    Pos   = { x = -1159.69, y = -1717.93, z = 3.45 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 27,
  },
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -1121.5, y = -1691.2, z = 3.45 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = -1128.93, y = -1683.25, z = 3.45 },
  ...
  VehicleDelivery = {
    Pos   = { x = -1136.17, y = -1695.28, z = 3.45 },
