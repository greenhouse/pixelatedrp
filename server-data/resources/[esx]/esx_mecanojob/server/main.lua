...
AddEventHandler('esx_mecanojob:onNPCJobMissionCompleted', function()
  ...
  totalPlayer  = total / 100 * 80
  totalSociety = total / 100 * 20

  TriggerEvent('esx_addonaccount:getSharedAccount', 'society_mecano', function(account)
    account.addMoney(totalSociety)
  end)

  xPlayer.addMoney(totalPlayer)

  TriggerClientEvent("esx:showNotification", _source, _U('your_comp_earned').. totalSociety)
  TriggerClientEvent("esx:showNotification", _source, _U('you_earned').. totalPlayer)
