...
ESX.RegisterUsableItem('chocolate', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onEat', source)
	TriggerClientEvent('esx:showNotification', source, 'You have eaten a ~b~Chocolate~s~')
end)
...
ESX.RegisterUsableItem('sandwich', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onEat', source)
	TriggerClientEvent('esx:showNotification', source, 'You have eaten a ~b~Sandwich~s~')
end)
...
ESX.RegisterUsableItem('icetea', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onDrink', source)
	TriggerClientEvent('esx:showNotification', source, 'You have drank a ~b~icetea~s~')
end)
...
ESX.RegisterUsableItem('redbull', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onDrink', source)
	TriggerClientEvent('esx:showNotification', source, 'You drank a ~b~redbull~s~')
end)
...
ESX.RegisterUsableItem('cocacola', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onDrink', source)
	TriggerClientEvent('esx:showNotification', source, 'You have drank a ~b~Coca Cola~s~')
end)
...
ESX.RegisterUsableItem('cupcake', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onDrink', source)
	TriggerClientEvent('esx:showNotification', source, 'You have eaten a ~b~Cupcake')
end)
