...
AddEventHandler('onMySQLReady', function ()
  Categories       = MySQL.Sync.fetchAll('SELECT * FROM vehicle_categories WHERE name != "utility" OR name != "lowrider"')
  local vehicles   = MySQL.Sync.fetchAll('SELECT * FROM vehicles WHERE brand != "custom" ')
