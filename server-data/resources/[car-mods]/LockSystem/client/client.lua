...
function Notify(text, duration)
	if(globalConf['CLIENT'].notification)then
		if(globalConf['CLIENT'].notification == 1)then
			...
			--Citizen.InvokeNative(0x1E6611149DB3DB6B, "CHAR_LIFEINVADER", "CHAR_LIFEINVADER", true, 1, "Car Lock", duration)
      ESX.ShowAdvancedNotification("Car Lock", "", text, "CHAR_LIFEINVADER", 1)
